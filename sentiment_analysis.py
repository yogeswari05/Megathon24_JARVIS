...
"""*From above, there are two columns in the dataset with null values: `Emotion` and `Text`. While the latter one is not really important, we should focus on the first column. We cannot remove these rows because the ratings and summary given from the customers will have some effects to our model later (although the number of missing rows is small). Because of it, we can fill the empty values with an empty string.*

**Filling Missing Values**
"""

dataset.Emotion.fillna(value = "", inplace = True)

"""**Concatenate `reviewText` and `summary` Columns**"""

# dataset["Emotion"] = dataset["Text"]
...
"""
def Labelling(Rows):
    # Mapping emotions to sentiment categories
    ...
    # Get the emotion from the row
    emotion = Rows["Emotion"]
    
    # Return the mapped sentiment
    return emotion_to_sentiment.get(emotion, "Neutral")  # Default to "Neutral" if emotion not found


dataset["sentiment"] = dataset.apply(Labelling, axis = 1)

dataset["sentiment"].value_counts().plot(kind = "bar", color = "black", figsize = (10, 5))
...
dataset["Text"] = dataset["Text"].apply(lambda Tex: Text_Cleaning(Tex))
dataset["Text"] = dataset["Text"].apply(lambda Tex: Text_Processing(Tex))
...
dataset["polarity"] = dataset["Text"].map(lambda Tex: TextBlob(Tex).sentiment.polarity)

dataset["polarity"].plot(kind = "hist", bins = 40, edgecolor = "blue", linewidth = 1, color = "orange", figsize = (10,5))
plt.title("Polarity Score in dataTrain", color = "blue", pad = 20)
plt.xlabel("Polarity", labelpad = 15, color = "red")
plt.ylabel("Amount of data", labelpad = 20, color = "green")
...
*From the histogram above, we know that most of the reviews are distributed in neutral statements
Review Length
"""

dataset["length"] = dataset["Text"].astype(str).apply(len)
...
plt.ylabel("Amount of datainputs", labelpad = 20, color = "green")
...
plt.title("Word Counts in data", color = "blue", pad = 20)
...
def Gram_Analysis(Corpus, Gram, N):
  ...
  Vectorizer = CountVectorizer(stop_words = Stopwords2, ngram_range=(Gram,Gram))
...
# Finding Unigram
words = Gram_Analysis(Positive["Text"], 1, 20)
...
plt.title("Unigram of datainputs with Positive Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
...
# Finding Unigram
words = Gram_Analysis(Neutral["Text"], 1, 20)
Unigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Unigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "orange", figsize = (10, 5))
plt.title("Unigram of datainputs with Neutral Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Unigram
words = Gram_Analysis(Negative["Text"], 1, 20)
Unigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Unigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "red", figsize = (10, 5))
plt.title("Unigram of datainputs with Negative Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Bigram
words = Gram_Analysis(Positive["Text"], 2, 20)
...
plt.title("Bigram of datainputs with Positive Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Bigram
words = Gram_Analysis(Neutral["Text"], 2, 20)
Bigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Bigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "orange", figsize = (10, 5))
plt.title("Bigram of datainputs with Neutral Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Bigram
words = Gram_Analysis(Negative["Text"], 2, 20)
Bigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Bigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "red", figsize = (10, 5))
plt.title("Bigram of datainputs with Negative Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Trigram
words = Gram_Analysis(Positive["Text"], 3, 20)
...
plt.title("Trigram of datainputs with Positive Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Trigram
words = Gram_Analysis(Neutral["Text"], 3, 20)
Trigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Trigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "orange", figsize = (10, 5))
plt.title("Trigram of datainputs with Neutral Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
# Finding Trigram
words = Gram_Analysis(Negative["Text"], 3, 20)
Trigram = pd.DataFrame(words, columns = ["Words", "Counts"])

# Visualization
Trigram.groupby("Words").sum()["Counts"].sort_values().plot(kind = "barh", color = "red", figsize = (10, 5))
plt.title("Trigram of datainputs with Negative Sentiments", loc = "center", fontsize = 15, color = "blue", pad = 25)
plt.xlabel("Total Counts", color = "magenta", fontsize = 10, labelpad = 15)
plt.xticks(rotation = 0)
plt.ylabel("Top Words", color = "cyan", fontsize = 10, labelpad = 15)
plt.show()
...
wordCloud = WordCloud(max_words = 50, width = 3000, height = 1500, stopwords = Stopwords).generate(str(Positive["Text"]))
...
wordCloud = WordCloud(max_words = 50, width = 3000, height = 1500, stopwords = Stopwords).generate(str(Neutral["Text"]))
plt.figure(figsize = (15, 15))
plt.imshow(wordCloud, interpolation = "bilinear")
plt.axis("off")
plt.show()
...
wordCloud = WordCloud(max_words = 50, width = 3000, height = 1500, stopwords = Stopwords).generate(str(Negative["Text"]))
plt.figure(figsize = (15, 15))
plt.imshow(wordCloud, interpolation = "bilinear")
plt.axis("off")
plt.show()
...
# emotion_probabilities = model.predict_proba(input_vector)

# # Map prediction to emotion label (assuming 0=Happy, 1=Sad, 2=Neutral)
# emotion_labels = {0: "Negative", 1: "Neutral", 2: "Positive"}
# predicted_emotion = emotion_labels[emotion_prediction[0]]

# print(f"Predicted Emotion: {predicted_emotion}")
# print(f"Emotion Probabilities: {emotion_probabilities}")
best_model = grid_search.best_estimator_  # Use the best estimator found by Grid Search
...
# Metrics
print(f"Accuracy On Test Set: {accuracy_score(y_test, Prediction) * 100:.2f}%")
ConfusionMatrix = confusion_matrix(y_test, Prediction)
...
plot_cm(ConfusionMatrix, classes=["Negative", "Neutral", "Positive"], title="Confusion Matrix of Sentiment Analysis")
print(classification_report(y_test, Prediction))
...
# Vectorize the input
input_vector = TF_IDF.transform(input_text)  # Ensure TF_IDF is fitted on training data

# Predict the emotion
emotion_prediction = best_model.predict(input_vector)  # Use the best fitted model
emotion_probabilities = best_model.predict_proba(input_vector)

# Map prediction to emotion label (assuming 0=Negative, 1=Neutral, 2=Positive)
emotion_labels = {0: "Negative", 1: "Neutral", 2: "Positive"}
predicted_emotion = emotion_labels[emotion_prediction[0]]
